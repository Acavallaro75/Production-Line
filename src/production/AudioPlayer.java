...
/**
 * The AudioPlayer class is a subclass of the Product class and implements all of the methods
 * contained inside the MultimediaControl interface. It contains all the methods inside both the
 * Product and MultimediaContol classes, respectively. The AudioPlayer() constructor is used to set
...
public class AudioPlayer extends Product implements MultimediaControl {
   ...
   * "supportedAudioFormat", and "supportedPlaylistFormat". The "name", "manufacturer", and
   * "ItemType" are passed to the parent, Product, class. The "supportedAudioFormats" and
   * "supportedPlaylistFormats" arguments are assigned to the field members "supportedAudioFormats"
   * and "supportedPlaylistFormats", respectively.
   *
   ...
   * here. It also calls the parent class, Product, and it's toString() method.
   *
